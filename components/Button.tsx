...
const Button = ({ text, link }: ButtonProps) => {
  return (
    ...
    >
      <div className="bg-dark w-full h-full relative overflow-hidden px-9 py-3 group-hover:shadow-md lg:group-hover:-rotate-12 transition-all duration-300 ease-in-out">
