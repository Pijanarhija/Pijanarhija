...
const aboutData: AboutData[] = [
  ...
  },
  {
    id: 2,
    title: "Приказната",
    text: "Добредојде во држава водена од алкохол, галама и хумор. Премиерот е исчезнат, законите не важат, а сите имаат теорија за сé. Бабата се кара во автобус, гасерот лета со 150км/h, а сељакот ти пушта уште една фора.",
    delay: 0.4,
  },
  {
    id: 3,
    title: "Твојата Мисија",
    text: "Во овој хаос, ти и твоето друштво мора да ги преживеете правилата кои останаа да важат, а тоа се правилата на народот. Издржи до крај со пијачка во рака, карти на маса, и многу мноогу смеење!",
    delay: 0.5,
  },
];
